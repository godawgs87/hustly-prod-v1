...
CREATE INDEX IF NOT EXISTS idx_listings_user_created_optimized 
ON public.listings (user_id, created_at DESC, status);

-- Index for status filtering with user context
CREATE INDEX IF NOT EXISTS idx_listings_user_status_fast 
...
CREATE INDEX IF NOT EXISTS idx_listings_inventory_query 
...
CREATE INDEX IF NOT EXISTS idx_listings_active_inventory 
